...
class Menu
{
    public static function pages()
    {
        ...
        foreach ($pages as $data) {
            echo '<a href="'.Url::to('/admin/page/'.$data['slug'].'').'" class=" d-block p-2 mb-0 rounded-1 d-flex align-items-center '.($name == ''.$data['slug'].'' ? 'menu-active' : 'text-light text-opacity-50 list-menu').'">
    ...
    public static function management()
    {
        ...
        <a href="'.Url::to('/admin/pages').'" class=" d-block p-2 mb-0 rounded-1 d-flex align-items-center '.(Yii::$app->controller->id == 'pages' ? 'menu-active' : 'text-light text-opacity-50 list-menu').'">
        ...
        <a href="'.Url::to('/admin/components').'" class=" d-block p-2 mb-0 rounded-1 d-flex align-items-center '.(Yii::$app->controller->id == 'components' ? 'menu-active' : 'text-light text-opacity-50 list-menu').'">
            <svg  xmlns="http://www.w3.org/2000/svg"  width="20"  height="20"  viewBox="0 0 24 24"  fill="none"  stroke="currentColor"  stroke-width="2"  stroke-linecap="round"  stroke-linejoin="round"  class="icon icon-tabler icons-tabler-outline icon-tabler-sitemap"><path stroke="none" d="M0 0h24v24H0z" fill="none"/><path d="M3 15m0 2a2 2 0 0 1 2 -2h2a2 2 0 0 1 2 2v2a2 2 0 0 1 -2 2h-2a2 2 0 0 1 -2 -2z" /><path d="M15 15m0 2a2 2 0 0 1 2 -2h2a2 2 0 0 1 2 2v2a2 2 0 0 1 -2 2h-2a2 2 0 0 1 -2 -2z" /><path d="M9 3m0 2a2 2 0 0 1 2 -2h2a2 2 0 0 1 2 2v2a2 2 0 0 1 -2 2h-2a2 2 0 0 1 -2 -2z" /><path d="M6 15v-1a2 2 0 0 1 2 -2h8a2 2 0 0 1 2 2v1" /><path d="M12 9l0 3" /></svg>
            <span class="ps-2">Components</span>
        </a>
        <a href="'.Url::to('/admin/seo').'" class=" d-block p-2 mb-0 rounded-1 d-flex align-items-center '.(Yii::$app->controller->id == 'seo' ? 'menu-active' : 'text-light text-opacity-50 list-menu').'">
        ...
        <a href="'.Url::to('/admin/header').'" class=" d-block p-2 mb-0 rounded-1 d-flex align-items-center '.(Yii::$app->controller->id == 'header' ? 'menu-active' : 'text-light text-opacity-50 list-menu').'">
        ...
        <a href="'.Url::to('/admin/footer').'" class=" d-block p-2 mb-0 rounded-1 d-flex align-items-center '.(Yii::$app->controller->id == 'footer' ? 'menu-active' : 'text-light text-opacity-50 list-menu').'">
        ...
        <a href="'.Url::to('/admin/settings').'" class=" d-block p-2 mb-0 rounded-1 d-flex align-items-center '.(Yii::$app->controller->id == 'settings' ? 'menu-active' : 'text-light text-opacity-50 list-menu').'">
