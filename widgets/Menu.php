...
class Menu
{
    ...
    public static function management()
    {
        ...
        <a href="'.Url::to(['/admin/home']).'" class=" d-block p-2 mb-1 rounded-1 d-flex align-items-center '.(Yii::$app->controller->id == 'home' ? 'menu-active' : 'text-light text-opacity-50 list-menu').'">
            ...
            <span class="ps-2">Home Page</span>
        </a>
