...
class Menu
{
    public static function pages()
    {
        ...
        echo '<div class="mb-1 mt-4 px-2 small text-light text-opacity-50 text-uppercase">Pages</div>';
        foreach ($pages as $data) {
            echo '<a href="'.Url::to('/admin/page/'.$data['slug'].'').'" class=" d-block p-2 mb-0 rounded d-flex align-items-center '.($name == ''.$data['slug'].'' ? 'menu-active' : 'text-light text-opacity-75 list-menu').'">
    ...
    {
        echo '
        <div class="mb-1 mt-4 px-2 small text-light text-opacity-50 text-uppercase">Management</div>
