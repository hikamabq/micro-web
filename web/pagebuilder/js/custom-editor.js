function registerCustomBlocks(editor){
      // 1 Kolom
      editor.BlockManager.add('1-column-custom', {
        label: '<br>1 Kolom',
        category: 'Layouts',
      ...
      // 2 Kolom
      editor.BlockManager.add('2-column-custom', {
        label: '<br>2 Kolom',
        category: 'Layouts',
      ...
      // 3 Kolom
      editor.BlockManager.add('3-column-custom', {
        label: '<br>3 Kolom',
        category: 'Layouts',
        attributes: { class: 'fa fa-columns' },
        content: {
      ...
      // 4 Kolom
      editor.BlockManager.add('4-column-custom', {
        label: '<br>4 Kolom',
        category: 'Layouts',
      ...
      // 2 Kolom 4/8
      editor.BlockManager.add('2-column-4-8', {
        label: '<br>2 Kolom 4/8',
        category: 'Layouts',
        attributes: { class: 'fa fa-columns' },
        content: {
          tagName: 'div',
          classes: ['row'],
          droppable: '.col-md-4, .col-md-8',
          components: [
            {
              tagName: 'div',
              classes: ['col-md-4'],
      ...
      editor.BlockManager.add('dynamic-post-3', {
        label: '<svg width="60" height="30" viewBox="0 0 60 30" fill="none" xmlns="http://www.w3.org/2000/svg"><rect width="60" height="30" fill="#14b8a6"/><rect x="4" y="6" width="16" height="21" fill="white"/><rect x="5" y="20" width="14" height="1" fill="#14b8a6"/><rect x="5" y="22" width="14" height="1" fill="#14b8a6"/><rect x="5" y="24" width="14" height="1" fill="#14b8a6"/><rect x="5" y="7" width="14" height="12" fill="#14b8a6"/><rect x="22" y="6" width="16" height="21" fill="white"/><rect x="23" y="20" width="14" height="1" fill="#14b8a6"/><rect x="23" y="22" width="14" height="1" fill="#14b8a6"/><rect x="23" y="24" width="14" height="1" fill="#14b8a6"/><rect x="23" y="7" width="14" height="12" fill="#14b8a6"/><rect x="40" y="6" width="16" height="21" fill="white"/><rect x="41" y="20" width="14" height="1" fill="#14b8a6"/><rect x="41" y="22" width="14" height="1" fill="#14b8a6"/><rect x="41" y="24" width="14" height="1" fill="#14b8a6"/><rect x="41" y="7" width="14" height="12" fill="#14b8a6"/></svg><br> Dynamic Post 3',
        content: `
      ...
      editor.BlockManager.add('dynamic-post-4', {
        label: '<svg width="60" height="30" viewBox="0 0 60 30" fill="none" xmlns="http://www.w3.org/2000/svg"><rect width="60" height="30" fill="#14b8a6"/><rect x="4" y="6" width="12" height="21" fill="white"/><rect x="4.75" y="20" width="10.5" height="1" fill="#14b8a6"/><rect x="4.75" y="22" width="10.5" height="1" fill="#14b8a6"/><rect x="4.75" y="24" width="10.5" height="1" fill="#14b8a6"/><rect x="4.75" y="7" width="10.5" height="12" fill="#14b8a6"/><rect x="17.5" y="6" width="12" height="21" fill="white"/><rect x="18.25" y="20" width="10.5" height="1" fill="#14b8a6"/><rect x="18.25" y="22" width="10.5" height="1" fill="#14b8a6"/><rect x="18.25" y="24" width="10.5" height="1" fill="#14b8a6"/><rect x="18.25" y="7" width="10.5" height="12" fill="#14b8a6"/><rect x="31" y="6" width="12" height="21" fill="white"/><rect x="31.75" y="20" width="10.5" height="1" fill="#14b8a6"/><rect x="31.75" y="22" width="10.5" height="1" fill="#14b8a6"/><rect x="31.75" y="24" width="10.5" height="1" fill="#14b8a6"/><rect x="31.75" y="7" width="10.5" height="12" fill="#14b8a6"/><rect x="45" y="6" width="12" height="21" fill="white"/><rect x="45.75" y="20" width="10.5" height="1" fill="#14b8a6"/><rect x="45.75" y="22" width="10.5" height="1" fill="#14b8a6"/><rect x="45.75" y="24" width="10.5" height="1" fill="#14b8a6"/><rect x="45.75" y="7" width="10.5" height="12" fill="#14b8a6"/></svg><br> Dynamic Post 4',
        content: `
      ...
      editor.BlockManager.add('container', {
          label: '<svg width="60" height="30" viewBox="0 0 60 30" fill="none" xmlns="http://www.w3.org/2000/svg"><rect width="60" height="30" fill="#14b8a6"/><rect x="9" y="3" width="22" height="1" transform="rotate(90 9 3)" fill="white"/><rect x="52" y="3" width="22" height="1" transform="rotate(90 52 3)" fill="white"/></svg> <br> Container',
          content: `
      ...
      editor.BlockManager.add('container-fluid', {
          label: '<svg width="60" height="30" viewBox="0 0 60 30" fill="none" xmlns="http://www.w3.org/2000/svg"><rect width="60" height="30" fill="#14b8a6"/><rect x="2" y="3" width="22" height="1" transform="rotate(90 2 3)" fill="white"/><rect x="59" y="3" width="22" height="1" transform="rotate(90 59 3)" fill="white"/></svg> <br> Container Fluid',
          content: `
      ...
      editor.BlockManager.add('carousel', {
          label: '<svg width="60" height="30" viewBox="0 0 60 30" fill="none" xmlns="http://www.w3.org/2000/svg"><rect width="60" height="30" fill="#14b8a6"/><path d="M53.5981 12.4019L58.0981 15L53.5981 17.5981L53.5981 12.4019Z" fill="white"/><path d="M6.59808 12.4019L2.09808 15L6.59808 17.5981L6.59808 12.4019Z" fill="white"/><rect x="16" y="24" width="8" height="1" fill="white"/><rect x="26" y="24" width="8" height="1" fill="white"/><rect x="36" y="24" width="8" height="1" fill="white"/></svg> <br> Carousel',
          content: `
    ...
    editor.BlockManager.add('button-custom', {
        label: '<svg width="60" height="30" viewBox="0 0 60 30" fill="none" xmlns="http://www.w3.org/2000/svg"><rect width="60" height="30" fill="#14b8a6"/><rect x="52" y="8" width="12" height="43" transform="rotate(90 52 8)" fill="white"/></svg><br> Button',
        content: `<button class="btn btn-dark">Text in here</button>`,
        category: 'Components',
    });
    editor.BlockManager.add('button-link', {
        label: '<svg width="60" height="30" viewBox="0 0 60 30" fill="none" xmlns="http://www.w3.org/2000/svg"><rect width="60" height="30" fill="#14b8a6"/><rect x="52" y="8" width="12" height="43" transform="rotate(90 52 8)" fill="white"/><rect x="24" y="10" width="8" height="13" transform="rotate(90 24 10)" fill="#14b8a6"/><rect x="37" y="13" width="2" height="13" transform="rotate(90 37 13)" fill="#14b8a6"/><rect x="50" y="10" width="8" height="13" transform="rotate(90 50 10)" fill="#14b8a6"/></svg><br> Button Link',
        content: `<a href="" class="btn btn-dark">Text in here</a>`,
        category: 'Components',
    });
    editor.BlockManager.add('image-custom', {
        label: '<svg width="60" height="30" viewBox="0 0 60 30" fill="none" xmlns="http://www.w3.org/2000/svg"><rect width="60" height="30" fill="#14b8a6"/><rect width="1" height="20.01" transform="matrix(-0.707107 -0.707107 -0.707107 0.707107 16.8563 12.7071)" fill="white"/><rect width="1" height="20.01" transform="matrix(-0.707107 -0.707107 -0.707107 0.707107 39.8563 7.70711)" fill="white"/><rect x="16" y="13.7071" width="1" height="20.01" transform="rotate(-45 16 13.7071)" fill="white"/><rect x="39" y="8.70711" width="1" height="25.9192" transform="rotate(-45 39 8.70711)" fill="white"/><circle cx="52" cy="8" r="2" fill="white"/></svg><br> Image',
        content: `<img src="...">`,
        category: 'Components',
    });
    editor.BlockManager.add('card-3', {
        label: '<svg width="60" height="30" viewBox="0 0 60 30" fill="none" xmlns="http://www.w3.org/2000/svg"><rect width="60" height="30" fill="#14b8a6"/><rect x="4" y="6" width="16" height="21" fill="white"/><rect x="5" y="17" width="14" height="1" fill="#14b8a6"/><rect x="5" y="19" width="14" height="1" fill="#14b8a6"/><rect x="5" y="21" width="14" height="1" fill="#14b8a6"/><rect x="5" y="7" width="14" height="9" fill="#14b8a6"/><rect x="5" y="23" width="8" height="3" fill="#14b8a6"/><rect x="22" y="6" width="16" height="21" fill="white"/><rect x="23" y="17" width="14" height="1" fill="#14b8a6"/><rect x="23" y="19" width="14" height="1" fill="#14b8a6"/><rect x="23" y="21" width="14" height="1" fill="#14b8a6"/><rect x="23" y="7" width="14" height="9" fill="#14b8a6"/><rect x="23" y="23" width="8" height="3" fill="#14b8a6"/><rect x="40" y="6" width="16" height="21" fill="white"/><rect x="41" y="17" width="14" height="1" fill="#14b8a6"/><rect x="41" y="19" width="14" height="1" fill="#14b8a6"/><rect x="41" y="21" width="14" height="1" fill="#14b8a6"/><rect x="41" y="7" width="14" height="9" fill="#14b8a6"/><rect x="41" y="23" width="8" height="3" fill="#14b8a6"/></svg><br> Card 3',
